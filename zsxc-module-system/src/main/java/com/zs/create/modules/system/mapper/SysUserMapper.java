...
public interface SysUserMapper extends BaseMapper<SysUser> {
    ...
    List<WorkflowUser> queryCandidatePersonal(@Param("username") String username, @Param("firstIndex") Integer firstIndex, @Param("lastIndex") Integer lastIndex);

    Long queryCandidatePersonalCount(WorkflowUser workflowUser);
}
