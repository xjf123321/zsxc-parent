...
import com.zs.create.modules.system.service.ISysPermissionDataRuleService;
import com.zs.create.modules.system.service.ISysPermissionService;
import com.zs.create.modules.system.service.ISysUserService;
import com.zs.create.common.aspect.annotation.PermissionData;
...
public class PermissionDataAspect {
    ...
    @Pointcut("@annotation(com.zs.create.common.aspect.annotation.PermissionData)")
    ...
    public Object arround(ProceedingJoinPoint point) throws Throwable {
        ...
        if (oConvertUtils.isNotEmpty(component)) {
            ...
            if (currentSyspermission == null) {
                ...
                if (regUrl != null) {
                    currentSyspermission = sysPermissionService.getOne(new LambdaQueryWrapper<SysPermission>()
        ...
        if (currentSyspermission != null) {
            ...
            if (dataRules != null && dataRules.size() > 0) {
                ZsxcDataAutorUtils.installDataSearchConditon(request, dataRules);

                //TODO 此处将用户信息查找出来放到request中实属无奈  可以优化
                SysUserCacheInfo userinfo = sysUserService.getCacheUser(username);
                ZsxcDataAutorUtils.installUserInfo(request, userinfo);
            }
        }
