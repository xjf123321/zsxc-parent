package com.zs.create.modules.quartz.service.impl;
...
import com.zs.create.modules.quartz.mapper.QuartzJobMapper;
import com.zs.create.modules.quartz.service.IQuartzJobService;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
    ...
    private void schedulerAdd(String jobClassName, String cronExpression, String parameter) {
        try {
            ...
            throw new ZsxcBootException("创建定时任务失败", e);
        } catch (Exception e) {
            throw new ZsxcBootException("后台找不到该类名：" + jobClassName, e);
        }
    }
    ...
    private void schedulerDelete(String jobClassName) {
        try {
            ...
            throw new ZsxcBootException("删除定时任务失败");
        }
    }
