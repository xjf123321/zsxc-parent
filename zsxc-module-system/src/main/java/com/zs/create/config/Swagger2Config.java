...
public class Swagger2Config implements WebMvcConfigurer {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //此包路径下的类，才生成接口文档
                .apis(RequestHandlerSelectors.basePackage("com.zs.create.modules"))
...
//                .globalOperationParameters(setHeaderToken());
    ...
    private List securityScheme() {
        return Collections.singletonList(new ApiKey(DefContants.X_ACCESS_TOKEN, DefContants.X_ACCESS_TOKEN, "header"));
    }
    ...
    List<SecurityReference> defaultAuth() {
        ...
        return newArrayList(new SecurityReference(DefContants.X_ACCESS_TOKEN, authorizationScopes));
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                // //大标题
                .title("武警安徽省总队网上办公系统API文档")
                // 版本号
                .version("1.0.0")
//				.termsOfServiceUrl("NO terms of service")
                // 描述
                .description("武警安徽省总队网上办公系统接口")
                // 作者
                .contact("软件研发中心项目部")
                .build();
    }
