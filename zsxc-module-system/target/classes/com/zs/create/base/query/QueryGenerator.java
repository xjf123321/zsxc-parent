package com.zs.create.base.query;

import com.alibaba.fastjson.JSON;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.zs.create.common.constant.CommonConstant;
import com.zs.create.common.system.query.QueryCondition;
import com.zs.create.common.system.query.QueryRuleEnum;
import com.zs.create.base.util.JwtUtil;
import com.zs.create.base.util.ZsxcDataAutorUtils;
import com.zs.create.common.util.SqlInjectionUtil;
...
public class QueryGenerator {
    ...
    public static void installMplus(QueryWrapper<?> queryWrapper, Object searchObj, Map<String, String[]> parameterMap) {
		...
		*/
        ...
        for (String c : ruleMap.keySet()) { //权限规则自定义SQL表达式
    ...
    private static QueryRuleEnum convert2Rule(Object value) {
        ...
        //update-begin--Author:lingrui  Date:20190724 for：initQueryWrapper组装sql查询条件错误 #284-------------------
        ...
        //update-end--Author:lingrui  Date:20190724 for：initQueryWrapper组装sql查询条件错误 #284---------------------
    ...
    public static Map<String, SysPermissionDataRule> getRuleMap() {
        ...
        List<SysPermissionDataRule> list = ZsxcDataAutorUtils.loadDataSearchConditon();
    ...
    private static String getLikeConditionValue(Object value) {
        String str = value.toString().trim(), result;
