...
import com.zs.create.common.constant.DataBaseConstant;
...
public class JwtUtil {
    ...
    // 过期时间30分钟
    public static final long EXPIRE_TIME = 5256000 * 60 * 1000;
     ...
     * @param request
     * @return
     * @throws ZsxcBootException
     */
    public static String getUserNameByToken(HttpServletRequest request) throws ZsxcBootException {
        String accessToken = request.getHeader("X-Access-Token");
        String username = getUsername(accessToken);
        if (oConvertUtils.isEmpty(username)) {
            throw new ZsxcBootException("未获取到用户");
        }
        return username;
    }
    ...
    public static String getUserSystemData(String key, SysUserCacheInfo user) {
        if (user == null) {
            user = ZsxcDataAutorUtils.loadUserInfo();
        }
        //#{sys_user_code}%
