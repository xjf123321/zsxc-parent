package com.zs.create.modules.message.job;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.zs.create.common.util.DateUtils;
import com.zs.create.modules.message.entity.SysMessage;
import com.zs.create.modules.message.handle.ISendMsgHandle;
import com.zs.create.modules.message.handle.enums.SendMsgStatusEnum;
import com.zs.create.modules.message.handle.enums.SendMsgTypeEnum;
import com.zs.create.modules.message.service.ISysMessageService;
...
public class SendMsgJob implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        log.info(String.format(" zsxc 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
