...
import com.zs.create.base.log.LogQueue;
...
public class SysBaseApiImpl implements ISysBaseAPI {
    ...
    public void addLog(String LogContent, Integer logType, Integer operatetype) {
        new Thread(() -> {
            saveLog(LogContent, logType, operatetype);
        }).start();
    }

    public static void saveLog(String LogContent, Integer logType, Integer operatetype) {
        ...
        LogQueue.getInstance().push(sysLog);
    }
        ...
        if ("".equals(DB_TYPE)) {
            ...
            try {
                ...
                if (dbType.indexOf("mysql") >= 0) {
                    ...
                    throw new ZsxcBootException("数据库类型:[" + dbType + "]不识别!");
                }
            } catch (Exception e) {
