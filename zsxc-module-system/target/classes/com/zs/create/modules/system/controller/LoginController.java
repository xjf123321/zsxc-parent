...
import com.zs.create.common.util.DySmsHelper;
import com.zs.create.common.util.PasswordUtil;
import com.zs.create.common.util.encryption.EncryptedString;
...
public class LoginController {
    ...
    public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel) throws Exception {
        ...
        //update-begin--Author:lingrui  Date:20190805 for：暂时注释掉密码加密逻辑，有点问题
        //前端密码加密，后端进行密码解密
        //密码解密
    ...
    public Result<JSONObject> loginfo() {
        ...
        //update-begin--Author:lingrui  Date:20190428 for：传入开始时间，结束时间参数
        // 获取一天的开始和结束时间
        ...
        //update-end--Author:lingrui  Date:20190428 for：传入开始时间，结束时间参数
