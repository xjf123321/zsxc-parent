...
import com.zs.create.modules.system.vo.SysDepartUsersVO;
import com.zs.create.modules.system.vo.SysUserRoleVO;
...
public class SysUserController {
    ...
    @Autowired
    private ZsOperationalSituationService zsOperationalSituationService;

    @Autowired
    private ZsTrainingExperienceService zsTrainingExperienceService;

    @Autowired
    private ZsRewardsService zsRewardsService;
    ...
    public Result<SysUser> add(@RequestBody JSONObject jsonObject) {
        ...
        try {
            ...
            user.setDelFlag(DelFlagEnum.NO_DEL);
        ...
        try {
            ...
            for (String id : arr) {
                if (oConvertUtils.isNotEmpty(id)) {
                    this.sysUserService.update(new SysUser().setStatus(SysUserStatusEnum.valueOf(status)),
    ...
    * */
    ...
    @ApiOperation(value = "根据id查询", notes = "测试-根据id查询")
    @RequestMapping(value = "/selectLawRecords", method = RequestMethod.GET)
    public Result<Map> selectLawRecords(@RequestParam(name = "id", required = true) String id) {
        Result<Map> result = new Result<Map>();
        Map map = new HashMap();
        map = sysUserService.selectByUserId(id);
        result.setResult(map);
        return result;
    }
    ...
    * */
     ...
     * 查询作战情况
     * */
    @AutoLog(value = "查询作战情况")
    @ApiOperation(value = "查询作战情况", notes = "查询作战情况")
    @RequestMapping(value = "/selectFight", method = RequestMethod.GET)
    public Result<List<ZsOperationalSituation>> selectFight(@RequestParam(name = "userId", required = true) String userId){
        Result<List<ZsOperationalSituation>> result = new Result<>();
        List<ZsOperationalSituation> list = zsOperationalSituationService.select(userId);
        result.setResult(list);
        return result;
    }
    ...
    * 作战情况保存
    * */
    @AutoLog(value = "保存作战情况")
    @ApiOperation(value = "保存作战情况", notes = "保存作战情况")
    @RequestMapping(value = "/saveFight", method = RequestMethod.POST)
    public Result<ZsOperationalSituation> saveFight(@RequestBody List<ZsOperationalSituation> list){
        Result<ZsOperationalSituation> result = new Result<ZsOperationalSituation>();
        try {
            zsOperationalSituationService.saveFight(list);
            result.success("保存成功");
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            result.error500("操作失败");
    ...
    * 删除作战情况
    * */
    @AutoLog(value = "删除作战情况")
    @ApiOperation(value = "删除作战情况", notes = "删除作战情况")
    @RequestMapping(value = "/deleteOperational", method = RequestMethod.DELETE)
    public Result<ZsOperationalSituation> deleteOperational(@Param("id") String id){
        Result<ZsOperationalSituation> result = new Result<>();
        try {
            zsOperationalSituationService.deleteOperational(id);
            result.success("删除成功");
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            result.error500("操作失败");
    ...
    * 查询培训经历
    * */
    @AutoLog(value = "查询培训经历")
    @ApiOperation(value = "查询培训经历", notes = "查询培训经历")
    @RequestMapping(value = "/selectTraining", method = RequestMethod.GET)
    public Result<List<ZsTrainingExperience>> selectTraining(@RequestParam(name = "userId", required = true) String userId){
        Result<List<ZsTrainingExperience>> result = new Result<>();
        List<ZsTrainingExperience> list = zsTrainingExperienceService.select(userId);
        result.setResult(list);
        return result;
    }
     ...
     * 培训经历保存
     * */
    @AutoLog(value = "保存培训经历")
    @ApiOperation(value = "保存培训经历", notes = "保存培训经历")
    @RequestMapping(value = "/saveTraining", method = RequestMethod.POST)
    public Result<ZsTrainingExperience> saveTraining(@RequestBody List<ZsTrainingExperience> list){
        Result<ZsTrainingExperience> result = new Result<ZsTrainingExperience>();
        try {
            zsTrainingExperienceService.saveTraining(list);
            result.success("保存成功");
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            result.error500("操作失败");
     ...
     * 删除作战情况
     * */
    @AutoLog(value = "删除培训经历")
    @ApiOperation(value = "删除培训经历", notes = "删除培训经历")
    @RequestMapping(value = "/deleteTraining", method = RequestMethod.DELETE)
    public Result<ZsTrainingExperience> deleteTraining(@Param("id") String id){
        Result<ZsTrainingExperience> result = new Result<>();
        try {
            zsTrainingExperienceService.deleteTraining(id);
            result.success("删除成功");
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            result.error500("操作失败");
     ...
     * */
    @AutoLog(value = "查询奖惩")
    @ApiOperation(value = "查询奖惩", notes = "查询奖惩")
    @RequestMapping(value = "/selectRecords", method = RequestMethod.GET)
    public Result<List<ZsRewards>> selectRecords(@RequestParam(name = "userId", required = true) String userId){
        Result<List<ZsRewards>> result = new Result<>();
        List<ZsRewards> list = zsRewardsService.select(userId);
        result.setResult(list);
        return result;
    }
     ...
     * 作战情况保存
     * */
    @AutoLog(value = "保存奖惩记录")
    @ApiOperation(value = "保存奖惩记录", notes = "保存奖惩记录")
    @RequestMapping(value = "/saveRecords", method = RequestMethod.POST)
    public Result<ZsRewards> saveRecords(@RequestBody List<ZsRewards> list){
        Result<ZsRewards> result = new Result<ZsRewards>();
        try {
            zsRewardsService.saveRecords(list);
            result.success("保存成功");
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            result.error500("操作失败");
     ...
     * 删除奖惩记录
     * */
    @AutoLog(value = "删除奖惩记录")
    @ApiOperation(value = "删除奖惩记录", notes = "删除奖惩记录")
    @RequestMapping(value = "/deleteRecords", method = RequestMethod.DELETE)
    public Result<ZsRewards> deleteRecords(@Param("id") String id){
        Result<ZsRewards> result = new Result<>();
        try {
            zsRewardsService.deleteRecords(id);
            result.success("删除成功");
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            result.error500("操作失败");
