...
import com.zs.create.base.util.YouBianCodeUtil;
import com.zs.create.modules.system.entity.SysDepart;
import com.zs.create.modules.system.mapper.SysDepartMapper;
import com.zs.create.modules.system.model.SysDepartTreeModel;
import com.zs.create.modules.system.service.ISysDepartService;
import com.zs.create.modules.system.util.FindsDepartsChildrenUtil;
...
public class SysDepartServiceImpl extends ServiceImpl<SysDepartMapper, SysDepart> implements ISysDepartService {
    ...
    private String[] generateOrgCode(String parentId) {
        //update-begin--Author:lingrui  Date:20190201 for：组织机构添加数据代码调整
        LambdaQueryWrapper<SysDepart> query = new LambdaQueryWrapper<SysDepart>();
        ...
        strArray[1] = orgType;
        return strArray;
        //update-end--Author:lingrui  Date:20190201 for：组织机构添加数据代码调整
    }
    ...
    public List<SysDepartTreeModel> searhBy(String keyWord) {
        ...
        //update-begin--Author:lingrui  Date:20140417 for：[bugfree号]组织机构搜索回显优化--------------------
        ...
        if (departList.size() > 0) {
            for (SysDepart depart : departList) {
                ...
                //update-end--Author:lingrui  Date:20140417 for：[bugfree号]组织机构搜索功回显优化----------------------
                newList.add(model);
            }
            return newList;
        }
